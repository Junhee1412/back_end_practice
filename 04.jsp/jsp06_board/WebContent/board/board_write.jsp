...
<body>
	<div class="container" align="center">
		...
		<form action="boardWrite.bo?p=${p}&f=${f}&q=${q}", method="post" class="form-group" 
			...
			<div class="form-group input-group">
				<div class="input-group-prepend"><span class="input-group-text"><i class="fis fa-user"></i></span></div>
				<input type="text" class="form-control" name="board_name" id="board_name" value="홍길동" required
				placeholder="작성자이름을 입력하세요..."/>
			</div>
			
			<div class="form-group input-group">
				<div class="input-group-prepend"><span class="input-group-text"><i class="fis fa-key"></i></span></div>
				<input type="password" class="form-control" name="board_pass" id="board_pass" value="12345" required
				placeholder="비밀번호를 입력하세요..."/>
			</div>

			<div class="form-group input-group">
				<div class="input-group-prepend"><span class="input-group-text"><i class="fis fa-clipboard"></i></span></div>
				<input type="text" class="form-control" name="board_subject" id="board_subject" value="<%= new java.util.Date() %>" required
				placeholder="제목을 입력하세요..."/>
			</div>
						
			<div class="form-group input-group">
				<div class="input-group-prepend"><span class="input-group-text"><i class="fis fa-comment-dots"></i></span></div>
			...
			<div class="form-group input-group">
				<div class="input-group-prepend"><span class="input-group-text"><i class="fis fa-file-alt"></i></span></div>
	...
	<script>
		$(".custom-file-input").on("change", function(){
			//var fileName = $(this).value();//전체파일명
			var fileName = $(this).val().split("\\").pop();//파일명만가져옴.
